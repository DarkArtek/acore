...
use Azura\Traits\AvailableStaticallyTrait;
...
class Settings extends Collection
{
    ...
    /**
     * @return string The base directory of the application, i.e. `/var/azuracast/www` for Docker installations.
     */
    ...
    /**
     * @return string The directory where temporary files are stored by the application, i.e. `/var/azuracast/www_tmp`
     */
